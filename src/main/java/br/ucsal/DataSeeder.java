...
public class DataSeeder implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                mockTrailProgressForDefaultEmployee();
        }
        ...
        private void createDefaultSkillsIfNotExists() {
                if (skillRepository.findAll().isEmpty()) {
                        ...
                        skillRepository.save(
                                        new Skill("UX Design",
                                                        "Ability to design intuitive interfaces and conduct usability studies"));
                        skillRepository.save(new Skill("UI Design",
                                        "Proficiency in designing visual interfaces using tools like Figma or Sketch"));

                        // Software Engineering Skills
                        skillRepository.save(
                                        new Skill("Spring Boot", "Experience in building REST APIs using Spring Boot"));
                        skillRepository
                                        .save(new Skill("Frontend Development",
                                                        "Skills in HTML, CSS, and JavaScript for web interfaces"));
                        skillRepository.save(new Skill("React",
                                        "Proficiency in building responsive UI components using React"));
                        ...
                        skillRepository.save(
                                        new Skill("Docker", "Beginner understanding of containerization using Docker"));
                        skillRepository
                                        .save(new Skill("Kubernetes",
                                                        "Familiar with deploying and scaling applications using Kubernetes"));
                        skillRepository.save(new Skill("CI/CD",
                        ...
                        skillRepository.save(
                                        new Skill("Data Analysis",
                                                        "Beginner level in exploring and analyzing data with Python or Excel"));
                        skillRepository.save(new Skill("Machine Learning",
                                        "Understanding of ML concepts and use of libraries like scikit-learn"));
                        skillRepository
                                        .save(new Skill("Data Engineering",
                                                        "Familiar with ETL pipelines and data transformation tools"));

                        // QA / Testing Skills
                        skillRepository.save(new Skill("Manual Testing",
                                        "Skilled in writing and executing test cases manually"));
                        skillRepository.save(
                                        new Skill("Automated Testing",
                                                        "Experience using Selenium or similar tools for test automation"));
                        skillRepository
                                        .save(new Skill("Performance Testing",
                                                        "Knowledge of load testing and performance benchmarking"));
